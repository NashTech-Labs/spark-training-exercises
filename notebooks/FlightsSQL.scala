package com.lightbend.training.sws.ex7.flights

import com.lightbend.training.data._
import com.lightbend.training.util.Timestamp
...
object FlightsSQL extends FlightsCommon {
  ...
  protected def computeFlightsBetweenAirports(
    flights: DStream[Flight], airportsOutPath: File, window: Duration, slide: Duration): Unit = {
